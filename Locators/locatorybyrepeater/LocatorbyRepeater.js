describe("learning locators by repeater", function () {

    it("Adding few records in table", function () {
    ...
    it("fetching the first record details", function () {

        console.log("fetching the records of first row");
        ...
        element.all(by.repeater("result in memory")).getText().then(function (rows) {
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                element(by.repeater("result in memory").row(i)).getText().then(function (text) {
                    ...
                    console.log("text received it " + text);
                })
                browser.sleep(2000);
            }
